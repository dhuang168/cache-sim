...
# ---------------------------------------------------------------------------
# Abstract base — the Core DES engine calls this interface only
# ---------------------------------------------------------------------------
...
class CacheOracleBase(ABC):
    ...
    def prefill_latency_us(
        ...
        """
        Returns (latency_us, confidence_label).
        uncached_tokens = tokens that must be freshly computed (not cached).
        """
        ...
    ...
    def kv_transfer_latency_us(
        ...
        """Transfer latency is always deterministic — no confidence needed."""
        ...
