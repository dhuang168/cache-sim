# Add these lines to your project's MEMORY.md

- [methodology_workflow.md](methodology_workflow.md) - Standard task sequence: research → plan → implement → verify → report → ship
- [methodology_debug.md](methodology_debug.md) - Debug cycle: observe → question → investigate → improve
- [methodology_testing.md](methodology_testing.md) - Test design: extreme conditions that force the feature to be the sole differentiator
